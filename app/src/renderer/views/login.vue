<template>
  <section class="login-wrap">
    <Form ref="form" class="login-form">
      ...
      <div class="fields">
        <Form-item prop="email" style="margin-bottom: 0">
          邮箱
          <Input class="field" v-model="login.email" width="320px"> </Input>
        </Form-item>

        <Form-item prop="secretkey" style="margin-bottom: 0">
          密钥
          <Input
            class="field"
        ...
        <Form-item prop="masterpassword" style="margin-bottom: 0">
          主密码
          <Input
            class="field"
      ...
      <div class="submit">
        <li>
          <input type="checkbox" id="public_pc_checkbox" />
          这是一个公共的或者共享的电脑
        </li>
        <Row>
          <Col span="7">
...
export default {
  ...
  methods: {
    synchronization () {
      ...
      var that = this
      this.$axios
        .post('http://49.235.114.122:8000/0password/api/v1/auth/sync', settings)
        .then(function (res) {
          debugger
